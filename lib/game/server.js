...
function getServerData() {
    return {welcomeText: config.backend.welcomeText, customObjectTypes: config.backend.customObjectTypes}
}

config.backend.router.get('/version', jsonResponse(request => ({protocol: PROTOCOL, useNativeAuth, serverData: getServerData()})));
